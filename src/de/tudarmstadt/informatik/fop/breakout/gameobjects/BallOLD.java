 ...
 *
 */
public class BallOLD extends Entity implements GameParameters {
		...
		XAxisCollision.addAction(new Action() {
			...
			public void update(GameContainer arg0, StateBasedGame arg1, int arg2, Component arg3) {
				...
				if (collider.getCollidedEntity().getID() == STICK_ID) {
					Physics2D.updateAngleOffset((BallOLD) collider.getOwnerEntity(), launcher);
				}
			}
		});
